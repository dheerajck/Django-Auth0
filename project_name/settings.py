...
SECRET_KEY = 'django-insecure-!2y(uhjmm&2%(x%vqj+jc^pkp-ua0dpkgr4fi*(xyxejjspph$'
...
# If user did not authorize the request, it will redirect to SOCIAL_AUTH_LOGIN_ERROR_URL when debug = False
MIDDLEWARE += [
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'app_name.auth0backend.create_custom_user',
